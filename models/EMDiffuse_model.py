...
class DiReP(BaseModel):
    def __init__(
        ...
        **kwargs,
        ...
        print('Total params Generator: %.3fM' % (total_params/1000000.0))
    ...
    def save_current_results(self):
        ...
        for idx in range(self.batch_size):
            ...
            # 'outputs' is only populated in test() when mean > 1 (uncertainty estimation)
            # val_step() runs once and does not produce 'outputs', so we check for existence.
